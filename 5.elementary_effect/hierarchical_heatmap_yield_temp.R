...
# ---------- 读取数据 ----------
EE_stats <- fread("5.elementary_effect/EE_outputs/EE_yield_rel_by_species_stats.csv")
...
pheatmap(
  ...
  filename = "figures/EE_yield_clustered_heatmap_mu_star_standardised_ward.D_method.png",
  width = 10,
  height = 12
)

# ---------- 单独保存行聚类树图（参数） ----------
png("figures/EE_yield_row_dendrogram_standardised_ward.D_method.png", width = 2200, height = 4000, res = 150)
...
# 
# ---------- 单独保存列聚类树图（物种） ----------
png("figures/EE_yield_col_dendrogram_species_standardised_ward.D_method.png", width = 800, height = 400)
